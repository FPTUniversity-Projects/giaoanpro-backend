...
namespace giaoanpro_backend.Application.Interfaces.Services
{
	public interface ISubscriptionService
	{
		...
		public Task<BaseResponse<GetMyCurrentAccessResponse>> GetCurrentAccessSubscriptionByUserIdAsync(Guid userId);
		public Task<BaseResponse<GetMySubscriptionDetailResponse>> GetUserSubscriptionByIdAsync(Guid subscriptionId, Guid userId);
		public Task<BaseResponse<GetSubscriptionDetailResponse>> GetSubscriptionByIdAsync(Guid subscriptionId);
